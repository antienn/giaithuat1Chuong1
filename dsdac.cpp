...
int main() {
	...
	do {
		...
		case 4:{
			...
			cin >> tmp;
			add1ItemInArr(ds, tmp, 0);
			break;
		}
		case 5:{
			cout << "moi ban nhap so de them vao cuoi mang" << endl;
			cin >> tmp;
			add1ItemInArr(ds, tmp, ds.n);
		}
		case 6:{
			delete1ItemInArr(ds, 0);
			break;
		}
		case 7:{
			delete1ItemInArr(ds, ds.n);
			break;
		}
		case 8:{
			cout << "moi ban nhap vi tri  ban muon xoa" << endl;
			cin >> tmp;
			delete1ItemInArr(ds, tmp);
			break;
		}
		case 9:{
